...
doc_events = {
    ...
    "WA Message": {
        # The bot, and only the bot. Unknown-contact verification is WABA-only by
        # design -- WA Line conversations are not asked for a KRA PIN. Adding
        # wa_verification here looks like closing a gap and is not.
