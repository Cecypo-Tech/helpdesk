  ...
  <div class="flex flex-col flex-1">
    ...
    <div class="pt-6 mx-auto w-full max-w-4xl px-5">
      <div class="flex flex-col gap-3 rounded-lg border w-full p-4">
        ...
        <!-- Title -->
        <textarea
          class="w-full resize-none border-0 bg-transparent text-3xl font-bold placeholder-ink-gray-3 p-0 pb-3 border-b border-outline-gray-2 focus:ring-0 focus:border-outline-gray-2"
          v-model="title"
