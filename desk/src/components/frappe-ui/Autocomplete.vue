...
const inputClasses = computed(() => {
  ...
  let variantClasses = {
    subtle:
      "border border-surface-gray-2 bg-surface-gray-2 placeholder-ink-gray-5 hover:border-surface-gray-3 hover:bg-surface-gray-3 focus:bg-surface-white focus:border-outline-gray-4 focus:shadow-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-outline-gray-3",
    outline:
      "border border-outline-gray-3 bg-surface-white placeholder-ink-gray-5 hover:border-outline-gray-4 hover:shadow-sm focus:bg-surface-white focus:border-outline-gray-4 focus:shadow-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-outline-gray-3",
    disabled: [
      "border bg-surface-gray-1 placeholder-ink-gray-4",
      props.variant === "outline" ? "border-outline-gray-3" : "border-transparent",
    ],
  }[variant];
